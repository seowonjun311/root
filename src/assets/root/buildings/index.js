...
export const castleImg =
  'https://media.base44.com/images/public/69b63292a629cfa39a4ab7d3/25e57f60f_castlepng.png';
...
const gymImages = [
  { level: 120, src: gymLv120Img },
  { level: 100, src: gymLv100Img },
  { level: 90,  src: gymLv90Img },
  { level: 70,  src: gymLv70Img },
  { level: 60,  src: gymLv60Img },
  { level: 50,  src: gymLv50Img },
  { level: 40,  src: gymLv40Img },
  { level: 30,  src: gymLv30Img },
  { level: 20,  src: gymLv20Img },
  { level: 10,  src: gymLv10Img },
  { level: 7,   src: gymLv7Img },
  { level: 5,   src: gymLv5Img },
  { level: 3,   src: gymLv3Img },
  { level: 1,   src: gymLv1Img },
];
...
const studyImages = [
  { level: 120, src: studyLv120Img },
  { level: 110, src: studyLv110Img },
  { level: 100, src: studyLv100Img },
  { level: 90,  src: studyLv90Img },
  { level: 80,  src: studyLv80Img },
  { level: 70,  src: studyLv70Img },
  { level: 60,  src: studyLv60Img },
  { level: 50,  src: studyLv50Img },
  { level: 40,  src: studyLv40Img },
  { level: 30,  src: studyLv30Img },
  { level: 20,  src: studyLv20Img },
  { level: 10,  src: studyLv10Img },
  { level: 7,   src: studyLv7Img },
  { level: 5,   src: studyLv5Img },
  { level: 3,   src: studyLv3Img },
  { level: 1,   src: studyLv1Img },
];
...
function getImageByLevel(level, table) {
  ...
  for (const item of table) {
    if (lv >= item.level) return item.src;
  }
