...
/>
              ...
              {tileMap.map((tile) => {
                ...
                const scale = (tileTheme === 'dino' || tileTheme === 'egypt') ? 1.4641 : (tileTheme === 'japan_garden' ? 2.2 : (tileTheme === 'steampunk' ? 1.327 : (tileTheme === 'joseon' ? 1.3 : (tileTheme === 'atlantis' ? 1.452 : 1.1))));
