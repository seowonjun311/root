...
export function getObjectScreenPosition(item, kind) {
  ...
  if (kind === 'decoration' && item?.type === 'japan_notice_board') return { x, y: y + TILE_H - 10 };
...
export function getDecorationImage(type) {
  ...
  if (type === 'japan_notice_board') return 'https://media.base44.com/images/public/69b63292a629cfa39a4ab7d3/6605dffad_ChatGPTImage202651502_58_12-Photoroom.png';
