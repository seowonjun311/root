...
export function getObjectScreenPosition(item, kind) {
  ...
  if (kind === 'decoration' && item?.type === 'bone_dino') return { x: x - 50, y: y + 99 };
...
export function createDecoration(subtype) {
  const sizeMap = {
    ...
    primitive_tent: 216,
    jungle_palm: 222,
    trex: 80, brachiosaurus: 180, triceratops: 90, ankylosaurus: 200, carnotaurus: 240, stegosaurus: 78, bone_dino: 216,
  };
