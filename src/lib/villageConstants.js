...
export const SHOP_THEMES = [
      ...
      },
  {
    ...
    emoji: '🏯',
    items: [
      { id: 'tile_joseon_1', label: '조선시대 돌바닥', type: 'tile', subtype: 'joseon', price: 80, image: 'https://media.base44.com/images/public/69b63292a629cfa39a4ab7d3/964a74eaa_image.png' },
