      ...
      <div className="flex flex-col items-center text-center px-6">
        ...
        <div className="space-y-3 mt-8 w-full">
          <button
            ...
            className="w-full py-3 rounded-xl font-semibold text-sm bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
          >
            <svg width="18" height="18" viewBox="0 0 48 48"><path fill="#FFC107" d="M43.6 20H24v8h11.3C33.6 32.9 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C33.7 6.4 29.1 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20c11 0 20-9 20-20 0-1.3-.1-2.7-.4-4z"/><path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.5 15.1 18.9 12 24 12c3 0 5.7 1.1 7.8 2.9l5.7-5.7C33.7 6.4 29.1 4 24 4 16.3 4 9.7 8.5 6.3 14.7z"/><path fill="#4CAF50" d="M24 44c5 0 9.5-1.9 12.9-4.9l-6-4.9C29.2 35.6 26.7 36.5 24 36.5c-5.2 0-9.5-3.1-11.3-7.6l-6.5 5C9.6 39.3 16.3 44 24 44z"/><path fill="#1976D2" d="M43.6 20H24v8h11.3c-.8 2.3-2.3 4.2-4.3 5.5l6 4.9C41.4 35 44 29.9 44 24c0-1.3-.1-2.7-.4-4z"/></svg>
            Google로 시작
          </button>
          <button
            onClick={() => base44.auth.redirectToLogin('/Onboarding')}
            className="w-full py-3 rounded-xl font-semibold text-sm bg-[#1877F2] text-white hover:bg-[#166FE5] transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => base44.auth.redirectToLogin('/Onboarding')}
            className="w-full py-3 rounded-xl font-semibold text-sm bg-black text-white hover:bg-gray-900 transition-colors flex items-center justify-center gap-2"
          >
