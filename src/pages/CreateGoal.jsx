        ...
        <div className="space-y-5">
          <div>
            ...
            <Input
              ...
              placeholder={category === 'daily' ? "예: 팩하기, 집청소, 설거지, 부모님 연락" : category === 'mental' ? "예: 7시기상, 일기쓰기, 부모님연락하기, 금연, ..." : category === 'study' ? "예: 독해, 듣기, 회화, 전공서, 수학, ..." : "예: 러닝, LC 공부, 명상..."}
        ...
        <div className="space-y-6">
          <div>
            ...
            <Input
              ...
              placeholder={category === 'daily' ? "예) 갓생살기, 일찍일어나기, 루틴찾기" : category === 'mental' ? "예) 자기관리, 생활규칙만들기, 절제, 나 챙기기" : "어떤 결과를 이루고 싶으신가요?"}
              className="h-12 rounded-xl bg-white/80"
            />
          </div>
          <div>
        ...
        <div className="space-y-5">
          <div>
            ...
            <Input
              value={actionTitle}
              onChange={e => setActionTitle(e.target.value)}
              placeholder={category === 'daily' ? "예: 팩하기, 집청소, 빨래, 부모님연락" : category === 'mental' ? "예: 7시기상, 일기쓰기, 부모님연락하기, 금연, ..." : category === 'study' ? "예: 독해, 듣기, 회화, 전공서, 수학, ..." : "예: 러닝, LC 공부, 명상..."}
              className="h-12 rounded-xl bg-white/80"
            />
          </div>
          <div>
