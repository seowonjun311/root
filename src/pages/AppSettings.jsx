      ...
      <Drawer open={showNickname} onOpenChange={setShowNickname}>
        <DrawerContent>
          ...
          <DrawerFooter className="flex gap-2 pt-4">
            ...
            <Button onClick={handleNicknameChange} disabled={nicknameUpdateMutation.isPending} className="flex-1 rounded-xl bg-amber-700 hover:bg-amber-800 text-amber-50">
              {nicknameUpdateMutation.isPending ? '변경 중...' : '확인'}
            </Button>
          </DrawerFooter>
        </DrawerContent>
      </Drawer>
